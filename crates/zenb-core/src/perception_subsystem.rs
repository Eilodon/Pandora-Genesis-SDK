...
use crate::skandha::zenb::{ZenbRupa, ZenbPipeline, zenb_pipeline};
use crate::skandha::{SensorInput, ProcessedForm, RupaSkandha};
...
impl PerceptionSubsystem {
    ...
    pub fn with_config(_config: &ZenbConfig) -> Self {
    ...
    fn process_with_circuit_breaker(&mut self, input: &SensorInput) -> Result<ProcessedForm, PerceptionError> {
