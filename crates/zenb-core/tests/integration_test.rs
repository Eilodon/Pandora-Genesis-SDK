...
fn long_session_fixed_to_dynamic_hash() {
    ...
    let st = &eng.skandha_pipeline.vedana.state(); // use belief_state as representative
    ...
    bstate1.apply(&zenb_core::domain::Envelope {
        ...
        event: zenb_core::domain::Event::BeliefUpdatedV2 {
            ...
            conf: st.conf,
            mode: st.mode as u8,
            free_energy_ema: eng.skandha_pipeline.vedana.fep_state().free_energy_ema,
            lr: eng.skandha_pipeline.vedana.fep_state().lr,
    ...
    let st2 = &eng2.skandha_pipeline.vedana.state();
    bstate2.apply(&zenb_core::domain::Envelope {
        ...
        event: zenb_core::domain::Event::BeliefUpdatedV2 {
            ...
            conf: st2.conf,
            mode: st2.mode as u8,
            free_energy_ema: eng2.skandha_pipeline.vedana.fep_state().free_energy_ema,
            lr: eng2.skandha_pipeline.vedana.fep_state().lr,
