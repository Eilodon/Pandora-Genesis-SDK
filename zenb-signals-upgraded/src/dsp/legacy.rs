...
impl DspProcessor {
    ...
    pub fn compute_heart_rate(signal: &Array1<f32>, fs: f32) -> (f32, f32) {
        ...
        // Refine peak location with parabolic interpolation for sub-bin accuracy
    ...
    ///
    /// This is a generalized version of `compute_heart_rate` that can be used for
    /// respiration (0.1..0.5 Hz) or other band-limited oscillations.
